...
export default class HomeScreen extends React.Component {
  ...
  submitAttendance = () => {
    ...
    db.ref('/').update({
      [year]: {
        [month]: {
          [date]: {
            Prasad: { Attendance: this.state.students.Prasad, Roll_No: 1 },
  ...
  render() {
    return (
      <View>
        <AppHeader />
        <Text style={styles.text2}>1. Prasad</Text>
        <TouchableOpacity
          style={styles.presentContainer}
          onPress={() => {
            this.setState({ Prasad: 'Present' });
            this.state.students.Prasad = 'Present';
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            this.setState({ Prasad: 'Absent' });
            this.state.students.Prasad = 'Absent';
          }}>
